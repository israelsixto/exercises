...
ggplot(data = mpg) + 
  geom_point(mapping = aes(x = hwy, y = manufacturer, color = year))
...
ggplot(data = diamonds_sample) +
  geom_point(mapping = aes(x = carat, y = price, size = clarity, color = price))
...
ggplot(data = diamonds_sample) +
  geom_histogram(mapping = aes(x = depth, color = clarity))
